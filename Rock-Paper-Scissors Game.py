...
label = Label(root,text="opponent ",width = 20,height=4,font=("algerian",15))
label.pack()
...
def spin():
    ...
    if user_select_value == 0:
        if choose_number == 0:
            wl_label.config(text="Tie! - "+" opponent:Bad luck")
        elif choose_number == 1:
            wl_label.config(text="YOU Loose - "+" opponent: I am better ")
        elif choose_number == 2 :
            wl_label.config(text="YOU Won - "+" opponent: You won by luck")

    elif user_select_value == 1:
        if choose_number == 1:
            wl_label.config(text="Tie! - "+" oppnonent: Nice game")
        elif choose_number == 0:
            wl_label.config(text="YOU Won - "+" opponent: Shit how you are better")
        elif choose_number == 2 :
            wl_label.config(text="YOU Loose - "+" opponent: booo")

    elif user_select_value == 2:
        if choose_number == 2:
            wl_label.config(text="Tie!")
        elif choose_number == 0:
            wl_label.config(text="YOU Loose - "+" opponent: I am playing this game since i was born")
        elif choose_number == 1 :
